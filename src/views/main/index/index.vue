...
<!--        <el-button type="primary" :icon="Plus" @click="handleAdd">{{ $t('message.common.addTestData') }}</el-button>-->
      ...
      <div class="layout-container-form-search">
        <el-input v-model="query.name" :placeholder="$t('message.common.searchTip')" @change="getTableData(true)"></el-input>
...
import {formatSize} from '@/utils/system/size'
import { getIndexList, deleteIndex } from '@/api/index'
