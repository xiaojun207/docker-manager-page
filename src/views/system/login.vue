      ...
      <div class="box-inner">
        ...
        <el-form class="form">
          ...
          <div style="margin-bottom: 10px;">
            <el-link type="primary" @click="$router.push({ path: '/forget' })">{{ $t('忘记密码') }}？</el-link>
          </div>
        ...
        <div class="fixed-top-right">
          <div class="right-item"><Docs style="margin-top: -13px;"/></div>
          <div class="right-item"><select-lang/></div>
        </div>
      </div>
...
import Docs from '@/layout/Header/functionList/docs.vue'
  ...
  setup() {
    ...
    const submit = () => {
      ...
      .then(() => {
        ...
        let params = {
          username: form.name,
          password: rsa.toEncrypt(form.password)
        }
